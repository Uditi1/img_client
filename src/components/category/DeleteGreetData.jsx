    ...
    <div className="w-full h-full justify-center items-center flex flex-col gap-4">
      ...
      <div className="flex flex-col ">
        <p className="font-satoshiBold text-[20px] text-center">
          Delete Daily Greetings
        </p>
        <p className="font-satoshiRegular leading-[28px] text-[16px] w-[280px] text-center">
          Are you sure you want to Delete Daily Greetings Category?
        </p>
      </div>
      ...
      <div className="flex w-full justify-between">
        ...
        <Button onClick={deleteCategory} className="w-[130px] h-[55px] bg-red text-white">Yes</Button>
      </div>
    </div>
  );
};

export default DeleteGreetData;
